...
def main():   
    ...
    monthly_payment, semi_monthly_payment, bi_weekly_payment, weekly_payment, rapid_bi_weekly_payment, rapid_weekly_payment = mortgage.payments(input_principal, input_interest, input_ammortization)
